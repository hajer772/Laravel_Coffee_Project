...
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <span class="text-muted">{{ __('words.show_clients') }}</span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
            ...
            <table class="table table-separate table-head-custom table-checkable" id="custom_datatable">
                ...
                @foreach ($clients as $key => $client)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <a href="{{$client->image}}"
                                   data-toggle="lightbox"
                                   data-gallery="gallery">
                                    <img class="index_image" src="{{ $client->image }}"
                                         onerror="this.src='{{ asset('uploads/default_image.png') }}'"
                                         alt="client-image">
                                </a>
                            @endif
                        ...
                        <td>{{ formatDate($client->created_at) == formatDate($client->updated_at) ? '--' : formatDate($client->updated_at) }}
                        </td>
                        <td nowrap="nowrap">
