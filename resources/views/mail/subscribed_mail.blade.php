                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#333333;font-size:16px">
                                                                    ...
                                                                    <br>
                                                                    <br>
                                                                    We would like to inform you that you have been
                                                                    subscriped in our newsletter , and we're happy to
                                                                    receive from us all our news
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td valign="top" align="center"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                                            <!--[if mso]><a href="{{request()->root()}}" target="_blank">
                                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                                 xmlns:w="urn:schemas-microsoft-com:office:word"
                                                                                 esdevVmlButton href="{{request()->root()}}"
                                                                                 style="height:44px; v-text-anchor:middle; width:190px"
                                                                                 arcsize="14%" stroke="f"
                                                                                 fillcolor="#5c68e2">
                                                                        <w:anchorlock></w:anchorlock>
                                                                        <center
                                                                            style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:18px; font-weight:400; line-height:18px; mso-text-raise:1px'>
                                                                            SHOP NOW
                                                                        </center>
                                                                    </v:roundrect>
                                                                </a><![endif]--><!--[if !mso]><!-- --><span
                                                                    ...
                                                                    style="border-style:solid;border-color:#2CB543;background:#5C68E2;border-width:0px;display:inline-block;border-radius:6px;width:auto;mso-hide:all"><a
                                                                        ...
                                                                        style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#f6f7f9;font-size:20px;padding:10px 30px 10px 30px;display:inline-block;background:#1d2e40;border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #5C68E2;padding-left:30px;padding-right:30px">
                                                                        Visit our website
                                                                            </a></span><!--<![endif]-->
                                                                <br>
                                                                <a href="{{route('news-letters.unsubscribe',$subscriber['id'])}}" style="padding: 1rem;color: #1d2e40;margin: 5rx;">
                                                                    unsubscribe
                                                                </a>
                                                            </td>
                                                        </tr>
