                        ...
                        <nav class="navbar navbar-expand-lg">
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <div class="navbar-nav ml-auto d-flex align-items-center">
                                    <a class="nav-link home link" href="{{ route('front.index') }}#home">{{ __("words.home") }}</a>
                                    <a class="nav-link link" href="{{ route('front.index') }}#about">{{ trans("words.about") }}</a>
                                    <a class="nav-link link" href="{{ route('front.index') }}#menu">{{ trans("words.menu") }}</a>
                                    <a class="nav-link link" href="{{ route('front.index') }}#reviews">{{ trans("words.review") }}</a>
                                    <a class="nav-link link " href="{{ route('front.index') }}#blog">{{ trans("words.news") }}</a>
                                    <a href=""
                                        class="btn button btn-medium btn-rounded btn-transparent ml-0 ml-lg-5"
                                        data-animation-duration="500" data-fancybox data-src="#animatedModal">{{__("words.order-now")}}</a>
                        ...
                        <div class="inner-wrapper">
                            ...
                            <div class="container">
                                <div class="row w-100 side-menu-inner-content">
                                    ...
                                    <div class="col-12 col-lg-8 text-center {{(App::isLocale('ar') ? 'text-lg-right' : 'text-lg-left')}}">
                                        <nav class="side-nav w-100">
                                            <ul class="navbar-nav">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ route('front.index') }}#home">{{ __("words.home") }}</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ route('front.index') }}#about">{{ __("words.about")}}</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ route('front.index') }}#menu">{{ __("words.menu")}}</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ route('front.index') }}#blog">{{ __("words.news")}}</a>
                                                </li>
                                                <li class="get-started-btn">
                                                    <a href=""
                                                        class="btn button btn-medium btn-rounded btn-transparent"
                                    ...
                                    <div class="col-12 col-lg-4 d-flex align-items-center text-center {{(App::isLocale('ar') ? 'text-lg-right' : 'text-lg-left')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" id="quote_name" name="quoteName"
                                            placeholder="{{ __("words.name") }}" required="" type="text">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" id="quote_contact" name="userPhone"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" id="quote_email" name="userEmail"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="userMessage" name="userMessage"
                                            placeholder="{{ trans("words.explain") }} "></textarea>
                                    </div>
                                </div>
