...
<section class="reviews" id="reviews" dir="{{ App::isLocale('ar') ? 'ltr' : 'ltr' }}">
    <div class="container">
        <div class="row align-items-center">
            <!-- Image -->
            <div class="col-12 col-md-6 wow  order-2 order-md-1 pt-5 pt-md-0 {{ App::isLocale('ar') ? 'fadeInRight' : 'fadeInLeft' }}"
            ...
            <!-- Content -->
            <div class="col-12 col-md-6 wow  order-1 order-md-2 {{ App::isLocale('ar') ? 'fadeInRight' : 'fadeInLeft' }}"
                data-wow-duration="1s" data-wow-delay=".5s">
                <div class="heading-area text-center">
                    <div class="mb-4"><img src=" {{ asset('front/images/gallery-border.png') }}" alt="About-line">
                    </div>
